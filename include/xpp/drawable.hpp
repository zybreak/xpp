...
namespace xpp {
    ...
    class drawable : public xpp::generic::resource<Connection, xcb_drawable_t, xpp::x::drawable, Interfaces ...> {
    protected:
        using base = xpp::generic::resource<Connection, xcb_drawable_t, xpp::x::drawable, Interfaces ...>;

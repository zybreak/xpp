...
namespace xpp {
    ...
    class colormap : public xpp::generic::resource<Connection, xcb_colormap_t, xpp::x::colormap, Interfaces ...> {
    protected:
        using base = xpp::generic::resource<Connection, xcb_colormap_t, xpp::x::colormap, Interfaces ...>;
    ...
    public:
        ...
        template<typename C>
        static colormap<Connection, Interfaces ...> create(C &&c, uint8_t alloc, xcb_window_t window, xcb_visualid_t visual) {
            return colormap(std::forward<C>(c), [&](const Connection &c, const xcb_colormap_t &colormap) {
        ...
        template<typename C>
        static colormap<Connection, Interfaces ...> create_checked(C &&c, uint8_t alloc, xcb_window_t window, xcb_visualid_t visual) {
            return colormap(std::forward<C>(c), [&](const Connection &c, const xcb_colormap_t &colormap) {

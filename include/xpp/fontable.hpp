...
namespace xpp {
    ...
    class fontable : public xpp::generic::resource<Connection, xcb_fontable_t, xpp::x::fontable, Interfaces ...> {
    protected:
        using base = xpp::generic::resource<Connection, xcb_fontable_t, xpp::x::fontable, Interfaces ...>;

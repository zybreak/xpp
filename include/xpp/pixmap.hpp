...
namespace xpp {
    ...
    class pixmap : public xpp::generic::resource<Connection, xcb_pixmap_t, xpp::x::pixmap, Interfaces ...> {
    protected:
        using base = xpp::generic::resource<Connection, xcb_pixmap_t, xpp::x::pixmap, Interfaces ...>;
    ...
    public:
        ...
        template<typename C>
        static pixmap<Connection, Interfaces ...> create(C &&c, uint8_t depth, xcb_drawable_t drawable, uint16_t width, uint16_t height) {
            return pixmap(std::forward<C>(c), [&](const Connection &c, const xcb_pixmap_t &pixmap) {
        ...
        template<typename C>
        static pixmap<Connection, Interfaces ...> create_checked(C &&c, uint8_t depth, xcb_drawable_t drawable, uint16_t width, uint16_t height) {
            return pixmap(std::forward<C>(c), [&](const Connection &c, const xcb_pixmap_t &pixmap) {

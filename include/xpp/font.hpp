...
namespace xpp {
    ...
    class font : public xpp::generic::resource<Connection, xcb_font_t, xpp::x::font, Interfaces ...> {
    protected:
        using base = xpp::generic::resource<Connection, xcb_font_t, xpp::x::font, Interfaces ...>;
    ...
    public:
        ...
        template<typename C>
        static font<Connection, Interfaces ...> open(C &&c, const std::string &name) noexcept {
            return font(std::forward<C>(c), [&](const Connection &c, const xcb_font_t &font) {
        ...
        template<typename C>
        static font<Connection, Interfaces ...> open_checked(C &&c, const std::string &name) {
            return font(std::forward<C>(c), [&](const Connection &c, const xcb_font_t &font) {
